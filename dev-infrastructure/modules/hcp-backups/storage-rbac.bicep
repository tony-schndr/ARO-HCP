...
@description('Principal ID of the hcp etcd backup job managed identity')
param etcdBackupJobManagedIdentityPrincipalId string
...
// ============================================================================
// ETCD Backup Job Managed Identity - Role Assignments
// Roles: Storage Blob Data Contributor # TODO REMOVE THIS, Storage Account Key Operator, Reader
// ============================================================================

resource etcdBackupJobStorageBlobDataContributorAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(storageAccountName, 'etcd-backup-job-blob-contributor', storageBlobDataContributorRole)
  scope: hcpBackupsStorageAccount
  properties: {
    principalId: etcdBackupJobManagedIdentityPrincipalId
    principalType: 'ServicePrincipal'
    roleDefinitionId: resourceId('Microsoft.Authorization/roleDefinitions', storageBlobDataContributorRole)
  }
}
