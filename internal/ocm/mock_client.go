...
//
//	mockgen -typed -source=client.go -destination=mock_client.go -package ocm ClusterServiceClientSpec
//
...
// CompleteRestore mocks base method.
func (m *MockClusterServiceClientSpec) CompleteRestore(ctx context.Context, internalID InternalID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CompleteRestore", ctx, internalID)
	ret0, _ := ret[0].(error)
	return ret0
}

// CompleteRestore indicates an expected call of CompleteRestore.
func (mr *MockClusterServiceClientSpecMockRecorder) CompleteRestore(ctx, internalID any) *MockClusterServiceClientSpecCompleteRestoreCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CompleteRestore", reflect.TypeOf((*MockClusterServiceClientSpec)(nil).CompleteRestore), ctx, internalID)
	return &MockClusterServiceClientSpecCompleteRestoreCall{Call: call}
}

// MockClusterServiceClientSpecCompleteRestoreCall wrap *gomock.Call
type MockClusterServiceClientSpecCompleteRestoreCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockClusterServiceClientSpecCompleteRestoreCall) Return(arg0 error) *MockClusterServiceClientSpecCompleteRestoreCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockClusterServiceClientSpecCompleteRestoreCall) Do(f func(context.Context, InternalID) error) *MockClusterServiceClientSpecCompleteRestoreCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockClusterServiceClientSpecCompleteRestoreCall) DoAndReturn(f func(context.Context, InternalID) error) *MockClusterServiceClientSpecCompleteRestoreCall {
...
func (m *MockClusterServiceClientSpec) StartRestore(ctx context.Context, internalID InternalID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StartRestore", ctx, internalID)
	ret0, _ := ret[0].(error)
	return ret0
}

// StartRestore indicates an expected call of StartRestore.
func (mr *MockClusterServiceClientSpecMockRecorder) StartRestore(ctx, internalID any) *MockClusterServiceClientSpecStartRestoreCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StartRestore", reflect.TypeOf((*MockClusterServiceClientSpec)(nil).StartRestore), ctx, internalID)
	return &MockClusterServiceClientSpecStartRestoreCall{Call: call}
}

// MockClusterServiceClientSpecStartRestoreCall wrap *gomock.Call
type MockClusterServiceClientSpecStartRestoreCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockClusterServiceClientSpecStartRestoreCall) Return(arg0 error) *MockClusterServiceClientSpecStartRestoreCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockClusterServiceClientSpecStartRestoreCall) Do(f func(context.Context, InternalID) error) *MockClusterServiceClientSpecStartRestoreCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockClusterServiceClientSpecStartRestoreCall) DoAndReturn(f func(context.Context, InternalID) error) *MockClusterServiceClientSpecStartRestoreCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
