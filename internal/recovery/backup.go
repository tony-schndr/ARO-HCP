...
func NewBackup(veleroNamespace, backupName, clusterId string, ttl time.Duration, namespaces ...string) *velerov1api.Backup {
	backup := builder.ForBackup(veleroNamespace, backupName).
