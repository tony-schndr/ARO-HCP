...
import (
	...
	"github.com/Azure/ARO-HCP/tooling/autobump/cmd"
)
...
func main() {
	...
	rootCmd := &cobra.Command{
		...
		Long: `autobump automatically fetches the latest image digests from container registries
...
checking for new image versions and updating configuration files accordingly.`,
	...
	rootCmd.AddCommand(cmd.NewAutobumpCommand())
